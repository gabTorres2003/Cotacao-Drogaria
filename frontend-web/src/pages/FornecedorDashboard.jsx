      ...
      try {
        if (usuarioId) {
          const response = await api.get(
            `/api/cotacao-fornecedor/fornecedor/${usuarioId}`,
          )
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          {/* Logo inserida no lugar do ícone genérico */}
          <img
              ...
              >
                ...
                <tbody>
                  {cotacoes.map((vinculo) => {
                    const idCotacao = vinculo.cotacao
                      ? vinculo.cotacao.id
                      : vinculo.id
                    const dataEnvio = vinculo.cotacao
                      ? vinculo.cotacao.dataCriacao || vinculo.dataEnvio
                      : vinculo.dataEnvio
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <button
                            onClick={() =>
                              navigate(`/responder-cotacao/${idCotacao}`)
                            }
                            style={{
                              backgroundColor: isRespondida
                                ? '#2563eb'
